...
<section class="content">
        ...
        <ol class="breadcrumb breadcrumb-bg-pink">
                                ...
                                <li><a href="javascript:void(0);"><i class="material-icons">group_add</i> Team</a></li>
                            </ol>
                    ...
                    <div class="card">
                        <div class="header">
                            ...
                            <div class="button-demo js-modal-buttons">
                                    <a href="#" class="btn btn-danger waves-effect">Add Team</a>
                                    </div>
                                </li>
                            </ul>
                        </div>
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h4 class="modal-title" id="defaultModalLabel">Add Team</h4>
                        </div>
