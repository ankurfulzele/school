...
<section class="content">
        ...
        <ol class="breadcrumb breadcrumb-bg-pink">
                                ...
                                <li><a href="javascript:void(0);"><i class="material-icons">assignment_ind</i> Pillars of Support</a></li>
                            </ol>
            ...
            <div class="row clearfix candidatetable">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        <div class="header">
                            <h2>PILLARS OF SUPPORT LIST</h2>
                            <ul class="header-dropdown m-r--5">
                                <li class="dropdown">                                    
                            <div class="button-demo js-modal-buttons">
                                    <a href="#" class="btn btn-danger waves-effect">Add Pillars of Support</a>
                                    </div>
                                </li>
                            </ul>
                        </div>
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h4 class="modal-title" id="defaultModalLabel">Add Pillars of Support</h4>
                        </div>
