                    ...
                    <div class="card">
                        <div class="header">
                            ...
                            <div class="button-demo js-modal-buttons">
                                    <a href="#" class="btn btn-danger waves-effect">Add Gallery</a>
                                    </div>
                                </li>
                            </ul>
                        </div>
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h4 class="modal-title" id="defaultModalLabel">Add Gallery</h4>
                        </div>
                        ...
                        <label>Category Name</label>
                                <div class="form-group">
                                    <div class="form-line">
                                    <select class="form-control show-tick" id="cname" name="cname" >
