...
<section class="content">
        ...
        <ol class="breadcrumb breadcrumb-bg-pink">
                                ...
                                <li><a href="javascript:void(0);"><i class="material-icons">text_fields</i> About Us</a></li>
                            </ol>
            <!-- #END# Widgets -->
            ...
            <form id="form_validation" method="POST" action="">
                              <label>Title Name</label>
                                <div class="form-group">
                                    <div class="form-line">
                                        <input type="text" value="{{$about->name}}" id="name" name="name" class="form-control" placeholder="Enter Title name">
                                    </div>
                                </div>
                                <label>Link</label>
                                <div class="form-group">
